...
/* --------- 48 seleções Copa 2026 — gf10/ga10 = gols marcados/sofridos últimos 10 jogos
   Fontes: FIFA, ESPN, clubedacopa.com.br, wikipedia (atualizado 24/06/2026)       */
const TEAMS = [
  { id:"ARG", name:"Argentina",       elo:2115, conf:"Am. do Sul", col:"#76B0E0", gf10:22, ga10:6  },
  { id:"BRA", name:"Brasil",          elo:1991, conf:"Am. do Sul", col:"#1FA64A", gf10:18, ga10:7  },
  { id:"COL", name:"Colômbia",        elo:1982, conf:"Am. do Sul", col:"#F2C811", gf10:16, ga10:8  },
  { id:"EQU", name:"Equador",         elo:1933, conf:"Am. do Sul", col:"#FFD100", gf10:13, ga10:9  },
  { id:"URU", name:"Uruguai",         elo:1890, conf:"Am. do Sul", col:"#62B4E6", gf10:12, ga10:8  },
  { id:"PAR", name:"Paraguai",        elo:1760, conf:"Am. do Sul", col:"#D9303A", gf10:10, ga10:11 },
  { id:"ESP", name:"Espanha",         elo:2157, conf:"Europa",     col:"#D9303A", gf10:24, ga10:5  },
  { id:"FRA", name:"França",          elo:2063, conf:"Europa",     col:"#2B5FB8", gf10:21, ga10:7  },
  { id:"ENG", name:"Inglaterra",      elo:2024, conf:"Europa",     col:"#D7D9DE", gf10:19, ga10:8  },
  { id:"POR", name:"Portugal",        elo:1989, conf:"Europa",     col:"#C42032", gf10:20, ga10:9  },
  { id:"NED", name:"Países Baixos",   elo:1960, conf:"Europa",     col:"#F2762E", gf10:17, ga10:9  },
  { id:"CRO", name:"Croácia",         elo:1935, conf:"Europa",     col:"#E53935", gf10:14, ga10:11 },
  { id:"NOR", name:"Noruega",         elo:1922, conf:"Europa",     col:"#BA1B2C", gf10:19, ga10:10 },
  { id:"GER", name:"Alemanha",        elo:1910, conf:"Europa",     col:"#D4AF37", gf10:23, ga10:8  },
  { id:"SUI", name:"Suíça",           elo:1897, conf:"Europa",     col:"#D52B1E", gf10:15, ga10:9  },
  { id:"TUR", name:"Turquia",         elo:1880, conf:"Europa",     col:"#E30A17", gf10:14, ga10:12 },
  { id:"BEL", name:"Bélgica",         elo:1850, conf:"Europa",     col:"#E4242C", gf10:15, ga10:10 },
  { id:"SWE", name:"Suécia",          elo:1820, conf:"Europa",     col:"#FECC02", gf10:13, ga10:10 },
  { id:"CZE", name:"Chéquia",         elo:1800, conf:"Europa",     col:"#3B7DD8", gf10:12, ga10:11 },
  { id:"AUT", name:"Áustria",         elo:1790, conf:"Europa",     col:"#ED2939", gf10:13, ga10:12 },
  { id:"SCO", name:"Escócia",         elo:1770, conf:"Europa",     col:"#3D7CC9", gf10:11, ga10:12 },
  { id:"BIH", name:"Bósnia",          elo:1720, conf:"Europa",     col:"#1C9BD7", gf10:10, ga10:14 },
  { id:"SEN", name:"Senegal",         elo:1869, conf:"África",     col:"#13934A", gf10:14, ga10:8  },
  { id:"MAR", name:"Marrocos",        elo:1850, conf:"África",     col:"#0E8C45", gf10:12, ga10:6  },
  { id:"EGY", name:"Egito",           elo:1790, conf:"África",     col:"#D81E27", gf10:12, ga10:10 },
  { id:"CIV", name:"Costa do Marfim", elo:1780, conf:"África",     col:"#FF8200", gf10:13, ga10:11 },
  { id:"ALG", name:"Argélia",         elo:1770, conf:"África",     col:"#15915A", gf10:11, ga10:10 },
  { id:"GHA", name:"Gana",            elo:1720, conf:"África",     col:"#1F9E47", gf10:10, ga10:12 },
  { id:"TUN", name:"Tunísia",         elo:1700, conf:"África",     col:"#E70013", gf10:10, ga10:12 },
  { id:"RSA", name:"África do Sul",   elo:1700, conf:"África",     col:"#0A7E47", gf10:9,  ga10:11 },
  { id:"CPV", name:"Cabo Verde",      elo:1620, conf:"África",     col:"#1A56A8", gf10:8,  ga10:12 },
  { id:"JPN", name:"Japão",           elo:1879, conf:"Ásia",       col:"#1B49B5", gf10:15, ga10:8  },
  { id:"IRN", name:"Irã",             elo:1780, conf:"Ásia",       col:"#239F40", gf10:11, ga10:9  },
  { id:"KOR", name:"Coreia do Sul",   elo:1760, conf:"Ásia",       col:"#D2293B", gf10:12, ga10:10 },
  { id:"AUS", name:"Austrália",       elo:1720, conf:"Ásia",       col:"#E8B800", gf10:10, ga10:12 },
  { id:"QAT", name:"Catar",           elo:1680, conf:"Ásia",       col:"#8A1538", gf10:8,  ga10:14 },
  { id:"UZB", name:"Uzbequistão",     elo:1650, conf:"Ásia",       col:"#1EB53A", gf10:9,  ga10:12 },
  { id:"KSA", name:"Arábia Saudita",  elo:1640, conf:"Ásia",       col:"#1A8A4A", gf10:8,  ga10:13 },
  { id:"JOR", name:"Jordânia",        elo:1600, conf:"Ásia",       col:"#1F8A4C", gf10:7,  ga10:14 },
  { id:"MEX", name:"México",          elo:1790, conf:"Am. Norte",  col:"#0B7A47", gf10:13, ga10:7  },
  { id:"USA", name:"Estados Unidos",  elo:1790, conf:"Am. Norte",  col:"#2A4FA0", gf10:14, ga10:10 },
  { id:"CAN", name:"Canadá",          elo:1730, conf:"Am. Norte",  col:"#D52B1E", gf10:15, ga10:9  },
  { id:"PAN", name:"Panamá",          elo:1710, conf:"Am. Norte",  col:"#D21034", gf10:9,  ga10:13 },
  { id:"CUW", name:"Curaçao",         elo:1600, conf:"Am. Norte",  col:"#1B4DA0", gf10:6,  ga10:17 },
  { id:"HAI", name:"Haiti",           elo:1570, conf:"Am. Norte",  col:"#1F3F9F", gf10:6,  ga10:18 },
  { id:"NZL", name:"Nova Zelândia",   elo:1600, conf:"Oceania",    col:"#C9CDD4", gf10:8,  ga10:13 },
  { id:"COD", name:"RD Congo",        elo:1700, conf:"Repescagem", col:"#2E8FE0", gf10:10, ga10:11 },
  { id:"IRQ", name:"Iraque",          elo:1630, conf:"Repescagem", col:"#CE1126", gf10:9,  ga10:12 },
];
      ...
      <div style={{ maxWidth: 560, margin: "0 auto", padding: "16px 14px", display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <div style={box}>
          <div style={{ fontSize: 11, color: C.dim, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 12 }}>
            Estatísticas — últimos 10 jogos
          </div>
          {[A, B].map((T, k) => {
            const avgGF = (T.gf10 / 10).toFixed(1);
            const avgGA = (T.ga10 / 10).toFixed(1);
            // prob de tomar gol = % jogos com ga >= 1, estimada via Poisson com λ = ga10/10
            const lGA = T.ga10 / 10;
            const pTakeGoal = Math.round((1 - Math.exp(-lGA)) * 100);
            const pScoreGoal = Math.round((1 - Math.exp(-T.gf10 / 10)) * 100);
            const offBar  = Math.min(100, Math.round(T.gf10 / 30 * 100));
            const defBar  = Math.min(100, Math.round(T.ga10 / 25 * 100));
            return (
              <div key={k} style={{ marginBottom: k === 0 ? 14 : 0 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                  <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 26, height: 26, borderRadius: 7, background: T.col, color: "#06090F", fontWeight: 800, fontFamily: mono, fontSize: 9.5 }}>{T.id}</span>
                  <span style={{ fontWeight: 700, fontSize: 13 }}>{T.name}</span>
                </div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 8 }}>
                  {[
                    ["Gols marcados", T.gf10, `${avgGF}/jogo`, C.fav],
                    ["Gols sofridos", T.ga10, `${avgGA}/jogo`, C.und],
                    ["Prob. tomar gol", `${pTakeGoal}%`, `marcar ${pScoreGoal}%`, C.draw],
                  ].map(([lab, val, sub, col], j) => (
                    <div key={j} style={{ background: C.bg, border: "1px solid " + C.lineSoft, borderRadius: 9, padding: "9px 10px", textAlign: "center" }}>
                      <div style={{ fontSize: 9, color: C.dim, textTransform: "uppercase", letterSpacing: "0.06em" }}>{lab}</div>
                      <div style={{ fontFamily: mono, fontSize: 18, fontWeight: 700, color: col, margin: "3px 0 1px" }}>{val}</div>
                      <div style={{ fontSize: 9.5, color: C.dim }}>{sub}</div>
                    </div>
                  ))}
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                  {[["Ataque", offBar, C.fav, T.gf10 + " gols em 10 jogos"], ["Vulnerabilidade", defBar, C.und, T.ga10 + " gols sofridos em 10 jogos"]].map(([lab, pct, col, hint], j) => (
                    <div key={j}>
                      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 9.5, color: C.dim, marginBottom: 3 }}>
                        <span>{lab}</span><span>{hint}</span>
                      </div>
